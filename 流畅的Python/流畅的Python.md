...
![[Pasted image 20220801223225.png]]
...
- 不可变序列 tuple、str 和 bytes。
 ...
 ![[Pasted image 20220801225850.png]]
...
![[Pasted image 20220801231614.png]]

---
### 第三章 字典和集合
#### 泛映射类型
![[Pasted image 20220802083608.png]]
...
#### 字典的变种
![[Pasted image 20220802091547.png]]
...
#### 集合的操作
![[Pasted image 20220802093318.png]]
![[Pasted image 20220802093404.png]]
- 中缀表达式版本要求左右两边的操作数都是相同的集合类型，而函数版本只要求第一个操作数是集合类型。
![[Pasted image 20220802093542.png]]
...
![[Pasted image 20220802095958.png]]
...
![[Pasted image 20220802190025.png]]
...
![[Pasted image 20220802225920.png]]
...
#### 序列协议
![[Pasted image 20220803195018.png]]
...
- ![[Pasted image 20220803201334.png]]
...
- ![[Pasted image 20220803205300.png]]
...
![[Pasted image 20220803215514.png]]
...
![[Pasted image 20220803221142.png]]
...
![[Pasted image 20220803224740.png]]
...
- 如果由于类型不兼容而 导致运算符特殊方法无法返回有效的结果，那么应该返回 NotImplemented，而不是抛出 TypeError。返回 NotImplemented 时，另一个操作数所属的类型还有机会执行运算，即 Python 会尝试调用反向方法。![[Pasted image 20220810172017.png]]
![[Pasted image 20220803225540.png]]
![[Pasted image 20220803225606.png]]
...
![[Pasted image 20220803225948.png]]
- [1,2] == (1, 2) 的结果是 False。
...
![[Pasted image 20220805145126.png|450]]
...
![[Pasted image 20220805152500.png]]
...
![[Pasted image 20220805161658.png]]
...
![[Pasted image 20220805164929.png]]

#### 生成器表达式
- 生成器表达式可以理解为列表推导的惰性版本：不会迫切地构建列表，而是返回一个生成 器，按需惰性生成元素。
![[Pasted image 20220805164702.png]]
...
#### 标准库中的生成器函数
![[Pasted image 20220805174733.png]]
![[Pasted image 20220805175249.png]]
![[Pasted image 20220805194229.png]]
![[Pasted image 20220805194543.png]]
![[Pasted image 20220805202520.png]]
...
![[Pasted image 20220805221149.png]]
...
![[Pasted image 20220805230642.png]]
...
#### 使用协程计算移动平均值
![[Pasted image 20220806083334.png]]
...
- 专门的术语：
	...
	- 调用方：调用委派生成器的客户端代码。
![[Pasted image 20220806094717.png]]
...
![[Pasted image 20220806154634.png]]
![[Pasted image 20220806154701.png]]
...
![[Pasted image 20220806162758.png]]
...
![[Pasted image 20220811223221.png]]
...
![[Pasted image 20220807000719.png]]
- 使用 \_\_new__ 方法取代 build 方法，构建可能是也可能不是 FrozenJSON 实例的新对象:
![[Pasted image 20220807000926.png]]
...
![[Pasted image 20220807080937.png]]

#### 定义一个特性工厂函数
![[Pasted image 20220807082858.png]]
![[Pasted image 20220807082935.png]]
...
![[Pasted image 20220807094502.png]]
**描述符实例声明为托管类的类属性**（Quantity 实例是 LineItem 类的类属性）

![[Pasted image 20220807111406.png]]
Quantity 实例是描述符，因此有个放大镜，用于获 取值（\_\_get__），以及一个手抓，用于设置值（\_\_set__）。
![[Pasted image 20220807111427.png]]

#### 描述符示例：验证属性
![[Pasted image 20220807142251.png]]
![[Pasted image 20220807142318.png]]
...
![[Pasted image 20220807142822.png]]
![[Pasted image 20220807142849.png]]
...
![[Pasted image 20220807152219.png]]
![[Pasted image 20220807152337.png]]
- **覆盖型描述符**	
	...
	![[Pasted image 20220807152809.png]]
![[Pasted image 20220807152852.png]]
- **没有__get__方法的覆盖型描述符**
	...
	![[Pasted image 20220807154216.png]]
	![[Pasted image 20220807154259.png]]
- **非覆盖型描述符**
	- 没有实现 \_\_set__ 方法的描述符是非覆盖型描述符。
	- 如果设置了同名的实例属性，描述符 会被遮盖，致使描述符无法处理那个实例的那个属性。
	- 方法是以非覆盖型描述符实现的。
	![[Pasted image 20220807161504.png]]
- 不管描述符是不是覆盖型，为类属性赋值都能覆盖描述符。
![[Pasted image 20220807161809.png]]
...
![[Pasted image 20220807162544.png]]
...
![[Pasted image 20220807164216.png]]
![[Pasted image 20220807164233.png]]
...
![[Pasted image 20220807183316.png]]
![[Pasted image 20220807183945.png]]
...
![[Pasted image 20220807192619.png]]
...
![[Pasted image 20220807195833.png]]
...
![[Pasted image 20220807200428.png]]
...
#### 定制描述符的元类
![[Pasted image 20220807220523.png]]
![[Pasted image 20220807220836.png]]
![[Pasted image 20220807223138.png]]
...
![[Pasted image 20220807225705.png]]
