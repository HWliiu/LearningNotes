...
![[Pasted image 20220807233618.png]]
...
- ![[Pasted image 20220807233640.png]]
- ![[Pasted image 20220807233658.png]]
- ![[Pasted image 20220807233719.png]]

#### Collection API
![[Pasted image 20220807234259.png]]

---
### CHAPTER 2 An Array of Sequences
![[Pasted image 20220807235858.png]]

- ![[Pasted image 20220808000529.png]]
#### tuples more efficient than lists
![[Pasted image 20220808001254.png]]
#### Unpacking with * in Function Calls and Sequence Literals
![[Pasted image 20220808001600.png]]
#### Pattern Matching
![[Pasted image 20220808002512.png]]
- **Sequence** 
	- ![[Pasted image 20220808074759.png]]
	...
	- ![[Pasted image 20220808083341.png]]![[Pasted image 20220808083404.png]]
	- ![[Pasted image 20220808084319.png]]
	- ![[Pasted image 20220808084537.png]]
	- ![[Pasted image 20220808084659.png]]

- **Mapping** 
	- ![[Pasted image 20220808075448.png]]
	...
	- ![[Pasted image 20220808080015.png]]
	- ![[Pasted image 20220808080207.png]]
- **Pattern Matching Class Instances**
	- *Simple Class Patterns*
		- ![[Pasted image 20220808090705.png]]
	- *Keyword Class Patterns*
		- ![[Pasted image 20220808092934.png]] ![[Pasted image 20220808093042.png]]
	- *Positional Class Patterns*
		- ![[Pasted image 20220808093911.png]]![[Pasted image 20220808093954.png]]![[Pasted image 20220808094011.png]]

---
### CHAPTER 3 Dictionaries and Sets
![[Pasted image 20220808100257.png]]

#### Modern dict Syntax
- **Unpacking Mappings**
![[Pasted image 20220808100815.png]]
- **Merging Mappings with |**
![[Pasted image 20220808101045.png]]

#### Pattern Matching with Mappings
[[#Pattern Matching]]

#### Inconsistent Usage of \_\_missing__ in the Standard Library
![[Pasted image 20220808102445.png]]

#### collections.OrderedDict
![[Pasted image 20220808102725.png]]
...
![[Pasted image 20220808105521.png]]
- ![[Pasted image 20220808105631.png]]

#### Set Operations
![[Pasted image 20220808110343.png]]
...
![[Pasted image 20220808112756.png]]
...
![[Pasted image 20220808112941.png]]
- ![[Pasted image 20220808113344.png]]
...
- ![[Pasted image 20220808113742.png]]
- Here is a Coordinate class built with namedtuple:![[Pasted image 20220808113901.png]]
- The newer typing.NamedTuple provides the same functionality, adding a type anno‐ tation to each field:![[Pasted image 20220808113934.png]]
- ![[Pasted image 20220808114103.png]]
- Since Python 3.6, typing.NamedTuple can also be used in a class statement, This is much more readable, and makes it easy to override methods or add new ones.![[Pasted image 20220808114600.png]]
- ![[Pasted image 20220808114725.png]]
...
- The `dataclass` decorator reads the variable annotations and auto‐ matically generates methods for your class.![[Pasted image 20220808115131.png]]

#### Main Features 
- ![[Pasted image 20220808115554.png]]
- ![[Pasted image 20220808115706.png]]

#### Classic Named Tuples 
- A named tuple offers a few attributes and methods in addition to those inherited from the tuple![[Pasted image 20220808120807.png]]
- Since Python 3.7, namedtuple accepts the defaults keyword-only argument provid‐ ing an iterable of N default values for each of the N rightmost fields of the class.![[Pasted image 20220808121258.png]]
...
- The only difference is the presence of the \_\_annotations__ class attribute.![[Pasted image 20220808142508.png]]
...
- *The Meaning of Variable Annotations*
	- The `a` survives only as an annotation. It doesn’t become a class attribute because no value is bound to it. The b and c are stored as class attributes because they are bound to values.![[Pasted image 20220808145617.png]]![[Pasted image 20220808145631.png]]
	- The a and b class attributes are descriptors. The c attribute is just a plain class attribute with the value 'spam'. The nt object has the a and b attributes as expected; it doesn’t have a c attribute, but Python retrieves it from the class, as usual.![[Pasted image 20220808145703.png]]![[Pasted image 20220808145722.png]]![[Pasted image 20220808150041.png]]
	- There is no attribute named a in DemoDataClass, because the a attribute will only exist in instances of DemoDataClass. It will be a public attribute that we can get and set, unless the class is frozen. But b and c exist as class attributes, with b holding the default value for the b instance attribute, while c is just a class attribute that will not be bound to the instances.![[Pasted image 20220808150312.png]]
- #### More About @dataclass
 ![[Pasted image 20220808151538.png]]
 ...
 - To prevent bugs, @data class rejects the class definition in Example 5-13.![[Pasted image 20220808162934.png]]
 - instead of a literal list, the default value is set by calling the dataclasses.field function with default_factory=list.![[Pasted image 20220808163302.png]]
 ...
 - ![[Pasted image 20220808163441.png]]
 - The default_factory is likely to be the most common option of the field function, but there are several others, listed in Table 5-3.![[Pasted image 20220808163728.png]]![[Pasted image 20220808163741.png]]
...
- ![[Pasted image 20220808164737.png]]
*TODO*
...
#### Soapbox
![[Pasted image 20220808170704.png]]![[Pasted image 20220808170743.png]]

---
### CHAPTER 6 Object References, Mutability, and Recycling
![[Pasted image 20220808171343.png]]

---
### CHAPTER 7 Functions as First-Class Objects
![[Pasted image 20220808182017.png]]

#### The Nine Flavors of Callable Objects 
![[Pasted image 20220808183440.png]]

#### Positional-Only Parameters
- To define a function requiring positional-only parameters, use / in the parameter list.![[Pasted image 20220808184029.png]]


---
### CHAPTER 8 Type Hints in Functions 
![[Pasted image 20220808185246.png]]

#### Using None as a Default
![[Pasted image 20220808193902.png]]
![[Pasted image 20220808193825.png]]
...
- For example, from the point of view of applicable operations, what are the valid types for x in the following function?![[Pasted image 20220808194808.png]]
...
![[Pasted image 20220808200639.png]]
...
- consistent-with: In a gradual type system, there is another relationship: consistent-with, which applies wherever subtype-of applies, with special provisions for type Any. ![[Pasted image 20220808202028.png]]
...
- ![[Pasted image 20220808203626.png]]
...
- ![[Pasted image 20220808204050.png]]
- ![[Pasted image 20220808204303.png]]
- ![[Pasted image 20220808204637.png]]![[Pasted image 20220808204954.png]]
...
- **Tuples as records with named fields**
	...
	- ![[Pasted image 20220808210204.png]]
...
- ![[Pasted image 20220808212519.png]]
...
- ![[Pasted image 20220808212756.png]]

#### Iterable
- ![[Pasted image 20220808213237.png]]
- ![[Pasted image 20220808213435.png]]
...
- ![[Pasted image 20220808214253.png]]
- ![[Pasted image 20220808214840.png]]
...
- *Restricted TypeVar:* TypeVar accepts extra positional arguments to restrict the type parameter.![[Pasted image 20220808215310.png]]
- *Bounded TypeVar:* In Example 8-18, we have `bound=Hashable`, which means the type parameter may be Hashable or any subtype of it.![[Pasted image 20220808215719.png]]
- To summarize:
...
- ![[Pasted image 20220808221615.png]]
- *TODO*
...
- ![[Pasted image 20220808232848.png]]

#### Annotating Positional Only and Variadic Parameters
![[Pasted image 20220808233447.png]]
...
- The PEP 484 convention is to prefix each positional-only parameter name with two underscores.![[Pasted image 20220808234411.png]]

#### Imperfect Typing and Strong Testing
![[Pasted image 20220808234619.png]]

---
### CHAPTER 9 Decorators and Closures
![[Pasted image 20220809232710.png]]

#### Memoization with functools.cache
![[Pasted image 20220809233636.png]]![[Pasted image 20220809233741.png]]![[Pasted image 20220809233949.png]]![[Pasted image 20220809234239.png]]
...
- ![[Pasted image 20220809234400.png]]

#### Function singledispatch
![[Pasted image 20220809234935.png]]![[Pasted image 20220809234958.png]]![[Pasted image 20220809235746.png]]![[Pasted image 20220809235856.png]]

#### A Class-Based Clock Decorator
![[Pasted image 20220810000625.png]]


---
### CHAPTER 10 Design Patterns with First-Class Functions
![[Pasted image 20220810000913.png]]
![[Pasted image 20220810002021.png]]

---
### CHAPTER 11 A Pythonic Object
![[Pasted image 20220810002903.png]]


---
### CHAPTER 12 Special Methods for Sequences
![[Pasted image 20220810075131.png]]

![[Pasted image 20220810082014.png]]

#### A Slice-Aware \_\_getitem__
![[Pasted image 20220810082259.png]]
...
---
![[Pasted image 20220810084653.png]]


---
### CHAPTER 13 Interfaces, Protocols, and ABCs
![[Pasted image 20220810085948.png]]

#### The Typing Map
![[Pasted image 20220810091306.png]]
...
![[Pasted image 20220810093001.png]]
...
- If insinstance(obj, Hashable) returns False, you can be certain that obj is not hashable. But if the return is True, it may be a false positive.![[Pasted image 20220810102653.png]]
...
#### Static Protocols
- ![[Pasted image 20220810110717.png]]
...
- ![[Pasted image 20220810124235.png]]
- ![[Pasted image 20220810143320.png]]

#### Limitations of Runtime Protocol Checks 
![[Pasted image 20220810144421.png]]Type hinting complex.\_\_float__ on typeshed would not solve this problem because Python’s runtime generally ignores type hints—and can’t access the typeshed stub files anyway.![[Pasted image 20220810144525.png]]
![[Pasted image 20220810144744.png]]
...
![[Pasted image 20220810153019.png]]

#### The numbers ABCs and Numeric Protocols 
![[Pasted image 20220810153213.png]]
...
![[Pasted image 20220810155313.png]]


---
### CHAPTER 14 Inheritance: For Better or for Worse
![[Pasted image 20220810160027.png]]

#### The super() Function
- Recommended way:![[Pasted image 20220810160755.png]]
- You may have seen code that doesn’t use super(), but instead calls the method directly on the superclass, like this:![[Pasted image 20220810160835.png]]
- It is useful to review how we had to call it in Python 2, because the old signature with two argu‐ ments is revealing:![[Pasted image 20220810161045.png]] Both arguments of super are now optional. The Python 3 bytecode compiler auto‐ matically provides them by inspecting the surrounding context when super() is invoked in a method.
...
#### Mixin Classes 
- ![[Pasted image 20220810162225.png]]
...
- ![[Pasted image 20220810162655.png]]



---
### CHAPTER 15 More About Type Hints 
![[Pasted image 20220809000100.png]]

#### Overloaded Signatures
![[Pasted image 20220809074049.png]]

#### TypedDict
![[Pasted image 20220809085355.png]]

![[Pasted image 20220809083624.png]]
...
- ![[Pasted image 20220809084124.png]]![[Pasted image 20220809084138.png]]

- ![[Pasted image 20220809085845.png]]![[Pasted image 20220809085927.png]]

#### Type Casting
![[Pasted image 20220809091131.png]]
...
- ![[Pasted image 20220809092751.png]]
...
- get_type_hints(obj, globals=None, locals=None, include_extras=False) […] : This is often the same as obj.\_\_annotations__. In addition, forward references encoded as string literals are handled by evaluating them in globals and locals namespaces. […]![[Pasted image 20220809093024.png]]
- PEP 563—Postponed Evaluation of Annotations was approved to make it unneces‐ sary to write annotations as strings, and to reduce the runtime costs of type hints. This PEP proposes changing function annotations and variable annotations so that they are no longer evaluated at function definition time. Instead, they are preserved in annotations in string form. ![[Pasted image 20220809114933.png]]![[Pasted image 20220809114906.png]]![[Pasted image 20220809093304.png]]The typing.get_type_hints function is able to resolve many type hints![[Pasted image 20220809093326.png]]That’s the recommended way to read type hints at runtime.

#### Implementing a Generic Class
![[Pasted image 20220809102008.png]]
![[Pasted image 20220809102026.png]]

![[Pasted image 20220809102540.png]]

#### Basic Jargon for Generic Types
![[Pasted image 20220809102454.png]]

#### Variance 
- Invariant: Python mutable collection types—such as list and set—are invariant.
- Covariance: the subtype relationship of the parameterized dispensers varies in the same direction as the subtype relationship of the type parameters.![[Pasted image 20220809104604.png]]
- ![[Pasted image 20220809105029.png]]![[Pasted image 20220809105045.png]]
...
- The Python 3.10 standard library provides a few generic static protocols. One of them is SupportsAbs![[Pasted image 20220809111905.png]]


---
### CHAPTER 16 Operator Overloading
![[Pasted image 20220810170740.png]]

#### Overloading + for Vector Addition 
![[Pasted image 20220810171144.png]]
![[Pasted image 20220810172518.png]]

#### Overloading * for Scalar Multiplication
![[Pasted image 20220810172546.png]]

#### Using @ as an Infix Operator
![[Pasted image 20220810173356.png]]
![[Pasted image 20220810172928.png]]



---
### CHAPTER 17 Iterators, Generators, and Classic Coroutines
![[Pasted image 20220810182030.png]]

#### Subgenerators with yield from
![[Pasted image 20220810193444.png]]

#### Generic Iterable Types
- Iterator types don’t appear as often as Iterable types, but they are also simple to write.![[Pasted image 20220810193859.png]]
...
![[Pasted image 20220810194658.png]]abc.Iterator[str] is consistent-with abc.Generator[str, None, None]. Iterator[T] is a shortcut for Generator[T, None, None]. Both annotations mean “a generator that yields items of type T, but that does not consume or return values.”

#### Classic Coroutines
![[Pasted image 20220810194950.png]]
- There are two different ways to annotate tuples with type hints:![[Pasted image 20220810195202.png]]Something similar happens with generators. They are commonly used as iterators, but they can also be used as coroutines.
- A coroutine is really a generator function, created with the yield keyword in its body. And a coroutine object is physically a generator object. Despite sharing the same underlying implementation in C, the use cases of generators and coroutines in Python are so different that there are two ways to type hint them:![[Pasted image 20220810195351.png]]
...
- Here is how typing.Generator was declared in the typing.py module of Python 3.6:![[Pasted image 20220810201710.png]]From the type variables in the formal parameters, we see that YieldType and Return Type are covariant, but SendType is contravariant.


---
### CHAPTER 18 with, match, and else Blocks
![[Pasted image 20220810202950.png]]

#### Context Managers and with Blocks
![[Pasted image 20220810203829.png]]
...
![[Pasted image 20220810205010.png]]![[Pasted image 20220810205026.png]]
A little-known feature of @contextmanager is that the generators decorated with it can also be used as decorators themselves.5 That happens because @contextmanager is implemented with the contextlib.ContextDecorator class.![[Pasted image 20220810205105.png]]


---
### CHAPTER 19 Concurrency Models in Python
![[Pasted image 20220810213637.png]]

#### A Bit of Jargon
![[Pasted image 20220810215602.png]]![[Pasted image 20220810221154.png]]![[Pasted image 20220810221210.png]]

#### Processes, Threads, and Python’s Infamous GIL
![[Pasted image 20220810221635.png]]![[Pasted image 20220810222301.png]]
![[Pasted image 20220810222917.png]]

#### A Concurrent Hello World
- **Spinner with Threads** ![[Pasted image 20220811152421.png]]![[Pasted image 20220811152448.png]]![[Pasted image 20220811152504.png]](线程同步对象的相关概念看threading.py源码，Lock-->RLock-->Condition-->Semaphore, Event, Barrier-->Timer)
- **Spinner with Processes**![[Pasted image 20220811152650.png]]one challenge when converting from threads to processes is how to communicate between processes that are isolated by the operating system and can’t share Python objects. This means that objects crossing process boundaries have to be serialized and deserialized, which cre‐ ates overhead. In Example 19-3, the only data that crosses the process boundary is the Event state, which is implemented with a low-level OS semaphore in the C code underlying the multiprocessing module.![[Pasted image 20220811152832.png]]
- **Spinner with Coroutines**
	...
	- ![[Pasted image 20220811162224.png]]![[Pasted image 20220811162309.png]]![[Pasted image 20220811162325.png]]
	...
	- ![[Pasted image 20220811162954.png]]

#### Supervisors Side-by-Side
![[Pasted image 20220811163822.png]]![[Pasted image 20220811163843.png]]
...
- Answer for asyncio:![[Pasted image 20220811170733.png]]![[Pasted image 20220811170753.png]]

#### A Homegrown Process Pool
![[Pasted image 20220811181521.png]]
![[Pasted image 20220811190131.png]]![[Pasted image 20220811190210.png]]![[Pasted image 20220811190417.png]]![[Pasted image 20220811190436.png]]


---
### CHAPTER 20 Concurrent Executors
![[Pasted image 20220811210208.png]]![[Pasted image 20220811210225.png]]

![[Pasted image 20220811211520.png]]

#### Downloading with concurrent.futures
![[Pasted image 20220811212816.png]]![[Pasted image 20220811220608.png]]![[Pasted image 20220811220712.png]]

#### Where Are the Futures?
![[Pasted image 20220811223053.png]]
![[Pasted image 20220811223113.png]]

#### Multicore Prime Checker Redux
![[Pasted image 20220811225114.png]]![[Pasted image 20220811225127.png]]
![[Pasted image 20220811225623.png]]


---
### CHAPTER 21 Asynchronous Programming
![[Pasted image 20220811232544.png]]

![[Pasted image 20220811232604.png]]

#### A Few Definitions
![[Pasted image 20220811233046.png]]

#### An asyncio Example: Probing Domains
![[Pasted image 20220811235944.png]]![[Pasted image 20220812000005.png]]![[Pasted image 20220812000022.png]]
![[Pasted image 20220812000038.png]]

#### Guido’s Trick to Read Asynchronous Code
![[Pasted image 20220812000852.png]]![[Pasted image 20220812002436.png]]
...
![[Pasted image 20220812084725.png]]![[Pasted image 20220812084746.png]]![[Pasted image 20220812084806.png]]![[Pasted image 20220812084824.png]]

#### The Secret of Native Coroutines: Humble Generators
![[Pasted image 20220812091125.png]]
...
- ![[Pasted image 20220812154959.png]]
...
- ![[Pasted image 20220812160011.png]]
...
- ![[Pasted image 20220812194952.png]]![[Pasted image 20220812195305.png]]
- ![[Pasted image 20220812195321.png]]
...
- ![[Pasted image 20220812200549.png]]![[Pasted image 20220812200602.png]]

#### Asynchronous generators as context managers
![[Pasted image 20220812202101.png]]![[Pasted image 20220812202115.png]]

#### Asynchronous generators versus native coroutines
![[Pasted image 20220812202715.png]]
...
- ![[Pasted image 20220812203413.png]]
...
![[Pasted image 20220812232733.png]]![[Pasted image 20220812232952.png]]
![[Pasted image 20220812233608.png]]

#### async Beyond asyncio: Curio
- Python’s async/await language constructs are not tied to any specific event loop or library.
- ![[Pasted image 20220812234155.png]]
- *TODO*

#### Type Hinting Asynchronous Objects
- The return type of a native coroutine describes what you get when you await on that coroutine, which is the type of the object that appears in the return statements in the body of the native coroutine function.![[Pasted image 20220812235048.png]]
- ![[Pasted image 20220812235211.png]]![[Pasted image 20220812235225.png]]
...
![[Pasted image 20220813074250.png]]
...
- ![[Pasted image 20220813091951.png]]
...
![[Pasted image 20220813093255.png]]

#### Automatic Naming of Storage Attributes
- ![[Pasted image 20220813104254.png]]
...
- ![[Pasted image 20220813104743.png]]![[Pasted image 20220813104850.png]]


---
### CHAPTER 24 Class Metaprogramming
![[Pasted image 20220813115401.png]]

#### type: The Built-In Class Factory
![[Pasted image 20220813120601.png]]
![[Pasted image 20220813120614.png]]
...
- ![[Pasted image 20220813155709.png]]

![[Pasted image 20220813184137.png]]
![[Pasted image 20220813185115.png]]![[Pasted image 20220813185200.png]]
![[Pasted image 20220813185524.png]]![[Pasted image 20220813185934.png]]![[Pasted image 20220813190113.png]]![[Pasted image 20220813190134.png]]

![[Pasted image 20220813185057.png]]
![[Pasted image 20220813185459.png]]
![[Pasted image 20220813190000.png]]
...
![[Pasted image 20220813191536.png]]![[Pasted image 20220813191557.png]]
...
- ![[Pasted image 20220813192715.png]]
...
- ![[Pasted image 20220814080501.png]]
...
![[Pasted image 20220814085909.png]]
